...
namespace Base.MathTools
{
    ...
    public class Matrix2
    {
        ...
        public Matrix2(Vector2 diagonal)
        {
            for (int i = 0; i < size; i++)
            {
                values[i, i] = diagonal[i];
        ...
        public static Matrix2 operator -(Matrix2 source)
        {
        ...
        public static Matrix2 Inverse(Matrix2 source)
        {
            Matrix2 result = Matrix2.Empty;
        ...
        public static Matrix2 Transpose(Matrix2 source)
        {
            Matrix2 matrix = Matrix2.Empty;
