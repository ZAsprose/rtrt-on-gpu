...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-NVIDIA-Windows-Debug.mk dist/NVIDIA-Windows-Debug/MinGW-Linux-x86/opengl_test

dist/NVIDIA-Windows-Debug/MinGW-Linux-x86/opengl_test: ${OBJECTFILES}
	${MKDIR} -p dist/NVIDIA-Windows-Debug/MinGW-Linux-x86
...
# Clean Targets
.clean-conf:
	${RM} -r build/NVIDIA-Windows-Debug
	${RM} dist/NVIDIA-Windows-Debug/MinGW-Linux-x86/opengl_test
