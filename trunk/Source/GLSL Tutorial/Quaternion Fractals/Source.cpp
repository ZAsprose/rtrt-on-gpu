...
struct Fractal
{
    public:
        ...
        GLuint MaximumIterations;

        /* Accuracy of hit point calculation of a ray with Julia set */
        GLfloat Epsilon;
        
        /* The escape threshold for the fractal iteration */
        GLfloat EscapeThreshold;

        /* Step for numerical estimation of a normal */
        GLfloat Delta;
        
        Fractal ( GLuint iterations = 100,
                  GLfloat epsilon = 0.005F,
                  GLfloat threshold = 10.0F,
                  GLfloat delta = 0.001F )
        {
        ...
        {
            manager->SetUniformFloat ( "Fractal.EscapeThreshold",
                                       EscapeThreshold );

            manager->SetUniformFloat ( "Fractal.Epsilon",
                                       Epsilon );

            manager->SetUniformFloat ( "Fractal.Delta",
                                       Delta );

            manager->SetUniformInteger ( "Fractal.MaximumIterations",
                                         MaximumIterations );

            manager->SetUniformVector ( "Fractal.Center",
                                        Center );
        }
};
