...
${OBJECTDIR}/ShaderManager.o: nbproject/Makefile-${CND_CONF}.mk ShaderManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ShaderManager.o ShaderManager.cpp

${OBJECTDIR}/Mouse.o: nbproject/Makefile-${CND_CONF}.mk Mouse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Mouse.o Mouse.cpp

${OBJECTDIR}/Texture3D.o: nbproject/Makefile-${CND_CONF}.mk Texture3D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Texture3D.o Texture3D.cpp
...
${OBJECTDIR}/Texture2D.o: nbproject/Makefile-${CND_CONF}.mk Texture2D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Texture2D.o Texture2D.cpp

${OBJECTDIR}/RenderBuffer.o: nbproject/Makefile-${CND_CONF}.mk RenderBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RenderBuffer.o RenderBuffer.cpp
...
${OBJECTDIR}/Texture1D.o: nbproject/Makefile-${CND_CONF}.mk Texture1D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Texture1D.o Texture1D.cpp
