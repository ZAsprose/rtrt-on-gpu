...
Vector3f colorAverage ( 0.6F, 0.6F, 0.6 );

Vector3f colorDispersion ( 0.4F, 0.4F, 0.4F );
...
void SetupKernels ( void )
{
...

	{
		...
		if ( !firstProgram->LoadVertexShader ( "ComputeVertex.glsl" ) )
		{
            std :: cout << "ERROR! Failed to load compute vertex shader!" << std :: endl;
            exit ( EXIT_FAILURE );
		}
		
		if ( !firstProgram->LoadFragmentShader ( "ComputeFragment.glsl" ) )
		{
...

	{
		...
		if ( !secondProgram->LoadVertexShader ( "ComputeVertex.glsl" ) )
		{
            std :: cout << "ERROR! Failed to load compute vertex shader!" << std :: endl;
            exit ( EXIT_FAILURE );
		}
		
		if ( !secondProgram->LoadFragmentShader ( "ComputeFragment.glsl" ) )
		{
            std :: cout << "ERROR! Failed to load compute fragment shader!" << std :: endl;
            exit ( EXIT_FAILURE );
		}
...

	{
		...
		if ( !renderProgram->LoadVertexShader ( "RenderVertex.glsl" ) )
		{
            std :: cout << "ERROR! Failed to load render vertex shader!" << std :: endl;
            exit ( EXIT_FAILURE );
		}
		
		if ( !renderProgram->LoadFragmentShader ( "RenderFragment.glsl" ) )
		{
